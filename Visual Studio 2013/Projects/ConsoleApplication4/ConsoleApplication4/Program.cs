...
namespace ConsoleApplication16
{
    public class MaxFlowFordFulkerson
    {
        ...
        {
            string file = File.ReadAllText("C:/Users/1/Downloads/input.txt");
            int[] info = file.Split(new char[] { ' ', '\n' }, StringSplitOptions.RemoveEmptyEntries).Select(n => int.Parse(n)).ToArray();
            string file1 = File.ReadAllText("C:/Users/1/Downloads/input.txt");
            ...
            for (int i = q * 2 + 2; i <= q * 2 + qLink * 3 - 1; i+=3) //48. 48+16=64
            {
