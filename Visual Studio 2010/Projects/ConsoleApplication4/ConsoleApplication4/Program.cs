...
namespace BinaryTree.I._7
{
    public class BinaryTree //класс, реализующий АТД «дерево бинарного поиска»
    {
        ...
        private class Node
        {
            ...
            public static int Preorder(Node r, ref int counter) //прямой обход дерева
            {
                if (r!=null)
                {
                    ...
                    Preorder(r.left,ref  counter);
                    Preorder(r.rigth,ref  counter);
                }
                return counter;
            }
        ...
        /*public static int znak (Node r, ref int counter)
        {
            Node.znak(r, counter);
            return counter;
        }*/
        ...
        public int Preorder(ref int counter)
        {
            Node.Preorder(tree,ref counter);
            return counter;
        }
